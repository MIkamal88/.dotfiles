...
return function()
  ...
  local mappings_tb = {}
  require("config.microchad.cheatsheet").organize_mappings(mappings_tb)
  ...
  local win = require("config.microchad.cheatsheet").getLargestWin()
  ...
  require("config.microchad.utils").set_cleanbuf_opts "nvcheatsheet"
