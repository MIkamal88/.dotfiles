...
awful.keyboard.append_global_keybindings({
	awful.key({ modkey }, "s", hotkeys_popup.show_help, { description = "help menu", group = "awesome" }),
...
awful.keyboard.append_global_keybindings({
	...
	end, { description = "open a firefox window", group = "launcher" }),
...
awful.keyboard.append_global_keybindings({
	...
	awful.key({ modkey }, "Left", awful.tag.viewprev, { description = "view previous", group = "layout" }),
	awful.key({ modkey }, "Right", awful.tag.viewnext, { description = "view next", group = "layout" }),
})
